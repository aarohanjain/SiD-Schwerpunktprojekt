 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Jul 01 11:22:13 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME QC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void QC_Outputs_wrapper(const real_T *u,
			real_T *y,
			const real_T *xD,
...
extern void QC_Update_wrapper(const real_T *u,
			real_T *y,
			real_T *xD,
			const real_T *Ad, const int_T p_width0,
			const real_T *Bd, const int_T p_width1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    QC_Outputs_wrapper(u, y, xD, Ad, p_width0, Bd, p_width1, Cd, p_width2, Dd, p_width3);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    QC_Update_wrapper(u, y, xD, Ad, p_width0, Bd, p_width1, Cd, p_width2, Dd, p_width3);
}
#endif /* MDL_UPDATE */
