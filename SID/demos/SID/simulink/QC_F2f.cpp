 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Aug 05 12:54:36 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME QC_F2f
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void QC_F2f_Outputs_wrapper(const real_T *u,
			const real_T *F,
			real_T *y,
			const real_T *xD,
...
extern void QC_F2f_Update_wrapper(const real_T *u,
			const real_T *F,
			real_T *y,
			real_T *xD,
			const real_T *Ad, const int_T p_width0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *Ad = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *Bd = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *Cd = (const real_T *) mxGetData(PARAM_DEF2(S));
    const real_T *Dd = (const real_T *) mxGetData(PARAM_DEF3(S));
    
    QC_F2f_Outputs_wrapper(u, F, y, xD, Ad, p_width0, Bd, p_width1, Cd, p_width2, Dd, p_width3);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    QC_F2f_Update_wrapper(u, F, y, xD, Ad, p_width0, Bd, p_width1, Cd, p_width2, Dd, p_width3);
}
#endif /* MDL_UPDATE */
